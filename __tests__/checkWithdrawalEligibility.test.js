...
// 	let closerCommentInBodyThenRemovedAlo9507Issue = 'https://github.com/OpenQDev/OpenQ-TestRepo/issues/125';
...
// 			expect(checkWithdrawalEligibility(closerCommentInBodyNoEditsAlo9507Issue, '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')).resolves.toEqual({ canWithdraw: true, errorMessage: null, issueId: 'I_kwDOGWnnz85GfZiD', type: 'SUCCESS' });
// 		});

// 		it.only('should NOT return true if Closes was not present at time of merge in body', async () => {
// 			expect(checkWithdrawalEligibility(closerCommentInBodyThenRemovedAlo9507Issue, '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')).resolves.toEqual({ canWithdraw: false, errorMessage: null, issueId: 'I_kwDOGWnnz85Gfb68', type: 'NO_CLOSER_COMMENT_AT_MERGE_TIME' });
// 		});
// 	});
