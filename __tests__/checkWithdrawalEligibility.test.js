...
describe('checkWithdrawalEligibility', () => {
	...
	describe('testing', () => {
		it.only('should return true for can withdraw based on pulls request body closer comment', async () => {
			expect(checkWithdrawalEligibility(issueReferencedAndMergedByFlacoJones, '')).resolves.toEqual({ canWithdraw: true, errorMessage: null, issueId: 'I_kwDOGWnnz85GjwA1', type: 'SUCCESS' });
		});
